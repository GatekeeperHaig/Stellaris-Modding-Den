...
class TabControlClass:
  def __init__(self,root):   
    ...
    self.newTab("Create AI Vars",createAIVarsFromModifiers,("text files","*.txt"),[],[of,"effect_name","no_traits", "no_buildings", "multiple_bonus_buildings","no_modifiers", "no_blocker",oll],"")
    self.tabClasses[-1].separateStart=False
