...
class TabControlClass:
  def __init__(self,root):   
    ...
    #"replacement_file",
    "time_discount","cost_discount","custom_direct_build_AI_allow","simplify_upgrade_AI_allow","load_order_priority","make_optional","different_same_name_vars",oll,"scripted_variables","skip_building","copy_folder_first"]
